...
import { MonthlyReportService } from "./services/monthly-report.service.js";
...
export async function buildApp() {
  ...
  const monthlyReportService = new MonthlyReportService(db);
  ...
  await monthlyReportsRoutes(app, monthlyReportService);
